            ...
            <div class="mixed-grid pad general-section">
                <div class="filter-menu">
                    <ul class="nav black works-filters text-center" id="filters">
                        ...
                        <li class="filter" data-filter=".healthcare">School</li>
                        <li class="filter" data-filter=".all">Action</li>
                        <li class="filter" data-filter=".residential">Game</li>
                        <li class="filter" data-filter=".healthcare">Detective</li>
                    </ul>
                </div>
                ...
                <div class="masonry-grid grid-col-4 black">
                    ...
                    <div class="grid-item all commercial">
                        <div class="grid">
                            <img src="{{url('img/news/ani1.jpg')}}}" width="400" height="273" alt="Recent Work"
                    ...
                    <div class="grid-item all commercial healthcare">
                        <div class="grid">
                            <img src="{{url('img/news/ani3.jpg')}}" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                                <a href="{{url('details')}}">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="grid-item all education">
                        <div class="grid">
                            <img src="img/news/ani5.jpg" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                    ...
                    <div class="grid-item all education residential">
                        <div class="grid">
                            <img src="img/news/ani7.jpg" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                                <a href="portfolio-single.html">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="grid-item all commercial">
                        <div class="grid">
                            <img src="img/news/ani9.jpg" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                                <a href="portfolio-single.html">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="grid-item all healthcare commercial">
                        <div class="grid">
                            <img src="img/news/a2.jpg" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                                <a href="portfolio-single.html">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="grid-item all healthcare commercial residential">
                        <div class="grid">
                            <img src="img/news/a4.jpg" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                                <a href="portfolio-single.html">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="grid-item all commercial healthcare education">
                        <div class="grid">
                            <img src="img/news/ani1.jpg" width="400" height="273" alt="Recent Work"
                                 class="img-responsive" />
                            <div class="figcaption">
                                <a href="potofolio-view.html">
                                    <i class="fa fa-link"></i>
                                </a></div>
                        </div>
                    </div>
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ URL::asset('js/jquery.parallax-1.1.3.j') }}s"></script>
    <!-- Fun Factor / Counter -->
...
@section('css')
    ...
    <!-- Color Scheme -->
    <link href="{{ URL::asset('css/color.cs') }}s" rel="stylesheet" />
@endsection
